<template>
  <div class="eleRecort-view module-content-box">
    ...
    <!-- 弹框：编辑 -->
    <DialogContainerized
      :title="editDialog.isNew ? '编辑电力计费' : '编辑电力计费'"
...
import electricReportEdit from './components/electricReportEdit'

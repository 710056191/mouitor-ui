  ...
  <div class="manufacturer-view module-content-box">
    ...
    >
      ...
      <el-table-column label="监控名称">
        <template slot-scope="scope">
          <span>{{ scope.row.monitorItem.itemName }}<span v-if="des[scope.row.monitorSet.devTypeCode][scope.row.monitorItem.itemCode]">({{ des[scope.row.monitorSet.devTypeCode][scope.row.monitorItem.itemCode] }})</span></span>
        </template>
      </el-table-column>

      <el-table-column label="模块ID">
        <template slot-scope="scope">
          <span>{{ scope.row.monitorSet.moduleChipId }}</span>
        </template>
      </el-table-column>

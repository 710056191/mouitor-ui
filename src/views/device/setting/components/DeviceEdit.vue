  ...
  <div>
    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="24">
          <el-form-item label="点位路名" prop="selfAddr1">
            <el-input v-model="temp.selfAddr1" placeholder="点位路名" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="点位位置" prop="selfAddr2">
            <el-input v-model="temp.selfAddr2" placeholder="点位位置" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="12">
          <!-- 网卡地址只能在添加时设置，添加后不能修改 -->
          <el-form-item label="网卡地址" prop="last6Mac">
            <el-input
              v-model="temp.last6Mac"
              :disabled="!isNew"
              placeholder="网卡地址"
              maxlength="12"
            />
